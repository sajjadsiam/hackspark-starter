...
class AnalyticsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRecommendations = channel.unary_unary(
                ...
                response_deserializer=analytics__pb2.RecommendationsResponse.FromString,
...
def add_AnalyticsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetRecommendations': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=analytics__pb2.RecommendationsResponse.SerializeToString,
            ),
    }
...
class AnalyticsService(object):
    ...
    def GetRecommendations(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            analytics__pb2.RecommendationsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
